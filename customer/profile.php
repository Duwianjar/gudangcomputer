    ...
    <section class="container mb-5" style="background-color: white;">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="mb-4 text-center">
                ...
                <img class="rounded-circle border border-success mb-3" width="200px" height="200px"
                    src="../image/profile/<?= $_SESSION["picture"] ?>" alt="" id="" name="">

                <div>
                    <label for="picture" class="btn btn-success btn-sm mb-2">
                        SELECT IMAGE
            ...
            <button type="submit" class="btn btn-success btn-sm mb-4" name="submit">CHANGE</button>
