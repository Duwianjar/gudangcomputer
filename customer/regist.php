    ...
    <div id="login-page">
        <div class="container position-absolute top-50 start-50 translate-middle w-auto">
            <div id="bg-form" style="background-color: rgba(0, 0, 0, 0.8);">
                <div class="form ps-3 pe-3 pt-3 pb-3 text-white border border-success border-3">
                    <form action="" method="post">
                        ...
                        <button type="submit" class="btn btn-success login" name="register">REGISTER</button>
                    </form>
                </div>
            </div>
        </div>
