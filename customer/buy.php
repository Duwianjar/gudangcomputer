...
<body>
    ...
    <section class="container">
        ...
        <form action="" method="post">
            ...
            <div class="bg-white mb-3 mt-3 border border-success shadow">
                <div class="mb-3 ps-4 pe-4 mt-3">
                    <label for="addres" class="form-label fw-bold fs-5 text-success">
            ...
            <div class="card mb-3 border border-success shadow" style="max-width: 100%;">
                <div class="row g-0">
                    <div class="col-md-2">
            ...
            <div class="bg-white mb-3 mt-3 border border-success shadow">
                <div class="mb-3 ps-4 pe-4 mt-3">
                    <label for="voucher" class="form-label fw-bold fs-5 text-success">
            ...
            <div class="bg-white mb-5 mt-3 border border-success shadow">
                ...
                <div class="mb-3 ps-4 pe-4 mt-3">
                    ...
                    <div class="d-flex">
                        <div class="p-2 fw-bold text-success fs-5"><i class="bi bi-credit-card"></i> Payment Method
                        </div>
                    ...
                    <div class="d-flex mb-3">
                        ...
                        <div class="p-2">:</div>
                        <div class="ms-auto p-2 fw-bold text-success fs-5"><?php echo rupiah($grand_total); ?></div>
                    ...
                    <p class="text-end">
                        <button name="buy" type="submit" class="btn btn-success btn-sm text-uppercase fw-bold">make an
                            order</button>
                    </p>
                </div>
            </div>
